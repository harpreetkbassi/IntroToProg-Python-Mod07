...
#   Harpreet Bassi, 8/10/2024, Created Script for Assignment07
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    ...
    def first_name(self, value: str):
        if not value.isalpha():
            raise ValueError("First name needs to be alphabetic.")
    ...
    def last_name(self, value: str):
        if not value.isalpha():
            raise ValueError("Last name needs to be alphabetic.")
...
while (True):
    ...
    if menu_choice == "1":  # This will not work if it is an integer!
        print("Please enter your responses for the following information...")
    ...
    # Save the data to a file
        ...
        print("Saving the information to the file...")
        FileProcessor.write_data_to_file(file_name=FILE_NAME, student_data=students)
        continue

    # Stop the loop
    elif menu_choice == "4":
        print("Data has been saved to the file, exiting the program...")
